 ...
 * @author Codisimus
 */
public class QuizBlockCommand implements CommandExecutor {
    ...
    private static void sendHelp(Player player) {
        ...
        player.sendMessage("§2/"+command+" make [Name]§b Makes Quiz at target location");
        player.sendMessage("§2/"+command+" move [Name]§b Moves Quiz to target location");
        player.sendMessage("§2/"+command+" link right [Name]§b Links target Block with Quiz");
        player.sendMessage("§2/"+command+" link door [Name]§b Links target Block with Quiz");
        player.sendMessage("§2/"+command+" link wrong [Name]§b Links target Block with Quiz");
        player.sendMessage("§2/"+command+" msg right [Name] [msg]§b Sets right msg for Quiz");
        player.sendMessage("§2/"+command+" msg wrong [Name] [msg]§b Sets wrong msg for Quiz");
        player.sendMessage("§2/"+command+" cmd right [Name] [Command]§b Sets right Cmd for Quiz");
        player.sendMessage("§2/"+command+" cmd wrong [Name] [Command]§b Sets wrong Cmd for Quiz");
        player.sendMessage("§2/"+command+" unlink§b Unlinks target Block from Quiz");
        player.sendMessage("§2/"+command+" delete (Name)§b Deletes Quiz and unlinks Block");
        player.sendMessage("§2/"+command+" list§b Lists all Quizes");
        player.sendMessage("§2/"+command+" rl§b Reloads QuizBlock plugin");
    }
}